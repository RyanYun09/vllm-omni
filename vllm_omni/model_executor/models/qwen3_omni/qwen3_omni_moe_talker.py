...
class Qwen3OmniMoeTalkerForConditionalGeneration(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # RFC #4872 P6: the codec token-id consistency guard is deliberately not
        # run at module import (it pulls in transformers / the qwen3-tts config).
        # Invoke it explicitly at model-load startup so the processor constants
        # stay in sync with the HF configs this model actually runs with.
